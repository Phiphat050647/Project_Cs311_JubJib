...
def buttom_all():
    global buttom_click_login,buttom_click_pag2,buttom_click_register,buttom_signup,button_back, button_confirm
...
def pag3(event):
        ...
        Label_buttom.bind("<Enter>",on_enter)
        Label_buttom.bind("<Leave>",on_leave)
        Label_buttom.bind("<Button-1>", gohome)
...
def proflie_pag(event):
    ...
    log_put.bind("<Button-1>", go_logout)
